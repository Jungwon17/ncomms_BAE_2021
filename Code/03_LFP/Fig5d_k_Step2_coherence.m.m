...
for type_i = 1:3
    ...
    for f_i = 3:length(temp_folder)
        ...
        for c_i = 1:8
            if ~isempty(temp_coh_channel{1,c_i}); checkChannel(c_i) = 1; end
        end
        ...
        for correct_i = 1:2
            ...
            for c_i = 1:8
                ...
                if isempty(temp_coh_channel{1,c_i}); continue; end
...
cd(paht_coh);
save('XX.mat','totCoh_cell','totCoh_cell_raw','freq','time');